...
function extractPathologies(reportText, impression, bodyRegion) {
  ...
  const pathologyPatterns = [
    ...
    { pattern: /\b(?:AVASCULAR\s*NECROSIS|AVN|OSTEONECROSIS)\b/i, label: 'Avascular Necrosis' },
    ...
    { pattern: /CARPAL\s*TUNNEL\s*(?:SYNDROME|COMPRESSION|NARROWING|PATHOLOGY)/i, label: 'Carpal Tunnel Syndrome' },
